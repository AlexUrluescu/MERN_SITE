import { Create, NotFoundPage, HomePage, Register, Login, FirstForm, MyPosts } from "./pages";
  ...
  return (
   <div>
      <Routes>
        ...
        <Route path="/myposts" element = {<MyPosts userLogin={userLogin} setUserLogin={setUserLogin}/>} />
